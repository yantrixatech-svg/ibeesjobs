        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500 flex flex-col gap-1">
                    {COMPANY.phones.map((phone, idx) => (
                      <a key={idx} href={`tel:${phone.replace(/\s+/g, '')}`} className="hover:text-[#0D1B5E] transition-colors font-medium">
                        {phone}
                      </a>
                    ))}
                  </div>
          ...
          <div>
            <div className="bg-white rounded-2xl border border-gray-100 p-6 md:p-8 shadow-sm sticky top-24">
              ...
              <p className="text-sm text-gray-500 mb-6">Fill out the form below. Clicking submit will open a pre-filled chat on WhatsApp.</p>
              ...
              {submitted ? (
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Redirected to WhatsApp!</h3>
                  <p className="text-sm text-gray-500 mb-4">Your inquiry details have been formatted and prepared. Please click the button below if the chat window did not open automatically.</p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    ...
                    className="w-full py-3.5 bg-green-600 text-white text-sm font-semibold rounded-xl hover:bg-green-700 hover:shadow-lg hover:shadow-green-600/20 transition-all duration-300 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
