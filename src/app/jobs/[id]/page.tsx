          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
              ...
              <a
                ...
                className="block w-full py-3 bg-[#0D1B5E] text-white text-sm font-semibold rounded-xl text-center hover:bg-[#1a2d7c] hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 mb-3 active:scale-95"
              >
                Apply Directly
              </a>
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-3 bg-green-50 text-green-700 text-sm font-semibold rounded-xl hover:bg-green-100 transition-all duration-300 active:scale-95"
              >
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-[#0D1B5E]">{job.category} Sector</span>
                </div>
                <div className="flex justify-between">
